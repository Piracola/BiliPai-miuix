...
class ModuleBoundaryReadinessStructureTest {
    ...
    private companion object {
         ...
         * 消除后从快照中移除并同步本集合。
         * 2026-08-16：移除 ArticleRepository（core.article）、DanmakuRepository
         * （core.danmaku）、VideoRepository（HomeFeedMergePolicy→core.policy、
         * PbpProgressPolicy→core.video.progress、BiliSubtitlePolicy→core.video.subtitle）。
         */
